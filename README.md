...
这是一个项目集合仓库，其中的项目代码**基本都由 AI 生成**。🤖

> 本仓库旨在探索 AI 辅助编程的可能性，展示人机协作开发的成果。从需求分析、架构设计到代码实现，AI 扮演了核心角色，人类则负责引导方向、审查代码和把控质量。

### 🛠️ 开发工具

本项目主要使用 [**Cursor**](https://cursor.com/) 进行开发。

**Cursor** 是一款 AI 驱动的代码编辑器，基于 VS Code 构建，深度集成了大语言模型（如 Claude、GPT-4 等）。它能够理解整个代码库的上下文，提供智能代码补全、代码生成、重构建议和自然语言对话式编程等功能，极大地提升了开发效率。
